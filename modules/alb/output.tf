...
output "alb_arn" {
  value       = "${join("", aws_lb.application.*.arn)}"
...
#   value       = "${join("", aws_security_group.application.*.id)}"
#   description = "The ID of the alb security group."
# }

# output "security_group_arn" {
#   value       = "${join("", aws_security_group.application.*.arn)}"
#   description = "The ARN of the alb security group."
# }

# output "security_group_vpc_id" {
#   value       = "${join("", aws_security_group.application.*.vpc_id)}"
#   description = "The VPC ID of the alb security group."
# }

# output "security_group_owner_id" {
#   value       = "${join("", aws_security_group.application.*.owner_id)}"
#   description = "The owner ID of the alb security group."
# }

# output "security_group_name" {
#   value       = "${join("", aws_security_group.application.*.name)}"
#   description = "The name of the alb security group."
# }

# output "security_group_description" {
#   value       = "${join("", aws_security_group.application.*.description)}"
#   description = "The description of the alb security group."
# }

# output "security_group_ingress" {
#   value       = "${aws_security_group.application.*.ingress}"
#   description = "The ingress rules of the alb security group."
# }

# output "security_group_egress" {
#   value       = "${aws_security_group.application.*.egress}"
